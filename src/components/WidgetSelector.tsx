...
export const WIDGET_REGISTRY: Omit<WidgetConfig, 'visible'>[] = [
  ...
  },
  {
    ...
    icon: '📜',
    description: 'Algorithmic intelligence summary with threat assessment',
    defaultSize: { w: 3, h: 8 },
  },
  {
    id: 'market-ticker',
  ...
  },
  {
    ...
    name: 'Feed Pipeline',
    icon: '📡',
    description: 'Real-time data flow pipeline visualization with throughput and queue health monitoring',
  ...
  },
  {
    ...
    icon: '🔄',
    description: 'Real-time data source synchronization status, health scores, and sync intervals',
    defaultSize: { w: 3, h: 12 },
  },
  {
    id: 'activity-waterfall',
    name: 'Activity Waterfall',
    icon: '🌊',
    description: 'Canvas-based spectrum waterfall visualization of signal activity over time',
    defaultSize: { w: 4, h: 10 },
  },
  {
    id: 'markets-terminal',
    ...
    icon: '💹',
    description: 'OpenBB-style financial terminal with screener, candlestick charts, heatmap, and earnings calendar',
    defaultSize: { w: 5, h: 14 },
  },
  {
    id: 'event-convergence',
    name: 'Event Convergence',
    icon: '🎯',
    description: 'Cross-stream correlation engine detecting when military, economic, disaster, and diplomatic signals converge on regions',
    defaultSize: { w: 4, h: 12 },
  },
  {
    id: 'memory-registry',
    ...
    icon: '🧠',
    description: 'Local-first intelligence memory system — capture, recall, dedupe, nightly maintenance',
    defaultSize: { w: 3, h: 12 },
  },
  {
    id: 'agentic-trading',
    ...
    icon: '🤖',
    description: 'AI-powered algorithmic trading agents across 40+ CEX/DEX venues — strategies, trades, arbitrage',
    defaultSize: { w: 3, h: 12 },
  },
  {
    id: 'pentagon-pizza',
